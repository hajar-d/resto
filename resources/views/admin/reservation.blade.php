        ...
        <div class="max-w-9xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <div class="py-8">
                        <h1 class="text-2xl font-semibold text-gray-800 mb-6">List of Reservations</h1>
                            ...
                            <table class="table-auto w-full border-collapse border text-center">
                                <thead>
                                    <tr class="bg-gray-100">
                                        ...
                                        <th class="px-4 py-2 border-b">Nombre Personne</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 border">{{ $reservation->nombr_pers }}</td>
                                        <td class="px-4 py-2 border">{{ $reservation->date_res }}</td>
                                        <td class="px-4 py-2 border">{{ $reservation->time_res }}</td>
                                        <td class="px-4 py-2 border">
                                            @if ($reservation->status == 'En attente')
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">
                                            En attente
                                            </span>
                                            @elseif ($reservation->status == 'disponible')
